...
const testPackets = () => {
    ...
    console.log((0, KADpackets_1.dissectJoinPacket)(packet));
    console.log("\n \n");
    let imgData = fs_1.default.readFileSync(__dirname + "\\CallaLily.gif");
    let imagePacket = (0, KADpackets_1.getImagePacket)({
        version: 7,
        messageType: 1,
        sequenceNumber: 5,
        timeStamp: 5,
    ...
    console.log((0, KADpackets_1.dissectSearchPacket)(searchPacket));
};
const testServer = () => {
    ...
    sock.connect({ port: port, host: ip, localPort: localPort }, () => {
        let packet = (0, KADpackets_1.getSearchPacket)({
            version: 7,
            messageType: 3,
            senderName: "magnus",
            originatingIP: ip,
